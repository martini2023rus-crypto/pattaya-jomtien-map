...
`lunvo/index.html` — страница-предложение партнёру, три части: вопрос 1 «SenWay входит в LUNVO»
(вклады, что просим, формула цены), вопрос 2 «Максим входит в SenWay» (доля за результат),
общее дело — совместная точка (вклады, деление прибыли, решения, выход); правила для обоих
вопросов, выходы при плохих сценариях, что нужно до решений, календарь.
